...
const TeamInfo: FC<TeamInfoProps> = () => {
  return (
    <div className="mx-auto px-5 pt-12 pb-24">
      ...
      <div className="-m-4 flex flex-wrap justify-center">
        <div className="p-4 md:w-1/2 lg:w-[300px]">
          <div className="flex h-full flex-col items-center text-center">
            ...
            <div className="w-full">
              ...
              <h3 className="mb-3 text-gray-500">Front-End, Game Developer</h3>
              ...
              <span className="inline-flex">
                <a
                  ...
                  title="dev-dong-su github"
                >
                  <svg className="h-8 w-10" viewBox="0 0 24 24">
        ...
        <div className="p-4 md:w-1/2 lg:w-[300px]">
          <div className="flex h-full flex-col items-center text-center">
            ...
            <div className="w-full">
              ...
              <h3 className="mb-3 text-gray-500">Back-End Developer</h3>
              <p className="mb-4 whitespace-pre">
                {'하나의 목적으로 움직이는 팀을\n만들고자 합니다.'}
              </p>
              <span className="inline-flex">
